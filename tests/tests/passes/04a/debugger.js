...
describe('Debugger', function() {
    ...
    it('should create an action', () => cli.do(`update ${actionName} ./data/foo.js`, this.app)
	.then(cli.expectJustOK)
       .then(sidecar.expectOpen)
       .then(sidecar.expectShowing(actionName)))

    /*it('should create another action, via let', () => cli.do(`let ${actionName2} = ./data/foo2.js`, this.app)
	.then(cli.expectJustOK)
       .then(sidecar.expectOpen)
