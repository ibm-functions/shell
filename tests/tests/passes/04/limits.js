...
describe('Create an action with limits', function() {
    ...
    it('should fail to create an action with --logs 2', () => cli.do(`action update ${actionName8} data/foo.js --logs 2`, this.app)
       .then(cli.expectError(499)) // unsupported optional parameter
       .catch(common.oops(this)))

    it('should create an action with --logsize 2', () => cli.do(`action update ${actionName8} data/foo.js --logsize 2`, this.app)
       .then(cli.expectOK)
       .then(sidecar.expectOpen)
    ...
    it('should create an action with --logsize 3', () => cli.do(`action update ${actionName8} data/foo.js --logsize 3`, this.app)
       .then(cli.expectOK)
       .then(sidecar.expectOpen)
       .then(sidecar.expectShowing(actionName8))
