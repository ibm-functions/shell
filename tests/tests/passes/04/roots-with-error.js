...
const common = require('../../../lib/common'),
      ...
      cli = ui.cli,
      sidecar = ui.sidecar,
      goodSeqName = '59E47471-F64B-4235-8FF0-00896DDB3AFB',
      errorSeqName = 'C6F15AE8-0DE7-4C6E-8695-CDF4B9544B13',

      // MAKE SURE THESE ARE UNIQUE TO THIS TEST!!!
      goodActionName = '94A2EF56-93EA-463A-9F6E-9FAF39AF9EE3',
      errorActionName = '085E6ACA-59E7-40E4-9C0A-BABB99BA976D'
...
describe('List root-most non-erroring activations with $$!', () => {
    ...
    it('should create an good action', () => cli.do(`update ${goodActionName} ./data/foo.js`, this.app)
	.then(cli.expectJustOK)
       .then(sidecar.expectOpen)
       .then(sidecar.expectShowing(goodActionName))
       .catch(common.oops(this)))
    it('should create an erroring action', () => cli.do(`update ${errorActionName} ./data/error.js`, this.app)
	.then(cli.expectJustOK)
       .then(sidecar.expectOpen)
