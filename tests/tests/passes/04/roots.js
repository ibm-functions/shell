...
const common = require('../../../lib/common'),
      ...
      cli = ui.cli,
      sidecar = ui.sidecar,
      seqName = 'roots-test-B98D0BB4-137D-4E35-B4AC-E22E1E8A2630',

      // MAKE SURE THESE ARE UNIQUE TO THIS TEST!!!
      actionNames = ['roots-test-DEE0231E-4911-4755-BB79-BFE971E53FD6',
...
describe('List root-most activations with $$', () => {
    ...
    // double check that $ ls shows a, b, and c
    actionNames.forEach(actionName => {
        it('should list all of the activations', () => cli.do(`$ ls --limit 100 --name ${actionName}`, this.app)
