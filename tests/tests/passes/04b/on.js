...
const common = require('../../../lib/common'),
      ...
      ruleName2 = `on_${triggerName}_do_${actionName2}`,
      ruleName3 = `on_${triggerName2}_do_${actionName2}`


describe('Create a rule via on', function() {
	...
	.then(cli.expectJustOK)
       ...
       .then(sidecar.expectRule([triggerName, actionName]))
       .catch(common.oops(this)))
	...
	.then(cli.expectJustOK)
       ...
       .then(sidecar.expectRule([triggerName, actionName2]))
       .catch(common.oops(this)))
	...
	.then(cli.expectJustOK)
       ...
       .then(sidecar.expectRule([triggerName2, actionName2]))
       .catch(common.oops(this)))
})
