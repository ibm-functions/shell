...
describe('Suggestions for command not found', function() {
     ...
     *
     **/
    const expectSuggestionsFor = (cmd, expectedAvailable, { click, expectedBreadcrumb, sidecar:expectedIcon }) => {
                                ...
                                .then(() => {
                                    if (expectedBreadcrumb) {
                                        ...
                                        return this.app.client.getText(breadcrumb)
                                            .then(actualBreadcrumb => assert.equal(actualBreadcrumb, expectedBreadcrumb))
                                        ...
                                        return sidecar.expectOpen(this.app)
                                            ...
                                            .then(actualIcon => assert.equal(actualIcon, expectedIcon))
                                    }
                                })
                        }
                    })
