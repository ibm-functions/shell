...
describe('Create a sequence, list it, delete it', function() {
    ...
    it('should create an action', () => cli.do(`action create foo ./data/foo.js`, this.app)
	.then(cli.expectJustOK)
       .then(sidecar.expectOpen)
       .then(sidecar.expectShowing('foo')))
    it('should create a second action', () => cli.do(`action create foo2 ./data/foo2.js`, this.app)
	.then(cli.expectJustOK)
       .then(sidecar.expectOpen)
    ...
    // list it
    it(`should find the new sequence with "ls"`, () => cli.do('action ls', this.app).then(cli.expectOKWith('sss')))
