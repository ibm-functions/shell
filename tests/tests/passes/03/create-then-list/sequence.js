...
describe('Create a sequence, then list it', () => {
    ...
    it('should create an action', () => cli.do(`create foo2 ./data/foo2.js`, this.app)
	.then(cli.expectJustOK)
       .then(sidecar.expectOpen)
    ...
    // list tests
    it(`should find foo with "ls"`, () => cli.do('ls', this.app).then(cli.expectOKWith('foo')))
    it(`should find foo2 "action ls"`, () => cli.do(`action ls`, this.app).then(cli.expectOKWith('foo2')))
    it(`should find sss1 with "action ls"`, () => cli.do(`action ls`, this.app).then(cli.expectOKWith('sss1')))
    it(`should find sss2 with "ls"`, () => cli.do(`ls`, this.app).then(cli.expectOKWith('sss2')))
    it(`should find sss3 with "action ls"`, () => cli.do(`action ls`, this.app).then(cli.expectOKWith('sss3')))
