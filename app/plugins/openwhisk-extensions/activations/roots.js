...
module.exports = (commandTree, require) => {
    const wsk = require('/ui/commands/openwhisk-core'),
          rootsDocs = { docs: `List the root-most activations, i.e. exclude components of sequences` },
          rootsDocsShortcut = { docs: `[Export Shortcut] List the root-most activations; shortcut for "wsk activation roots"` },
          rootsWithErrorsDocs = { docs: `As with roots, but showing only those root activations with errors` },
          rootsWithErrorsDocsShortcut = { docs: `[Export Shortcut] Root activations with errors` }

    const roots = (op, filterFn = acceptAll) => (block, nextBlock, fullArgv, modules, command) => {
