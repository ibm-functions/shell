 ...
 *
 */
module.exports = (cmd, partial=false) => {
    ...
    return [
        ...
        { name: 'let.js', docs: 'introducing a value', command: `${gen('let-demo')} @demos/let.js`, partial },
        { name: 'retain.js', docs: 'forwarding values around untrusted code', command: `${gen('retain-demo')} @demos/retain.js`, partial },
